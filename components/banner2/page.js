...
const Banner2 = () => {
    return (
        <div className="mb-8 bg-[#5BA1B2] flex flex-col-reverse md:flex md:flex-row">
            <div className="w-full md:w-1/2 text-white p-6">
                ...
                <div className="border-white border-l-2 border-t-4 p-6 font-semibold">
                    ...
                    <div className="flex flex-col md:flex md:flex-row justify-center items-center my-4 gap-2">
            ...
            <Image className="w-full md:w-1/2" src={"/banner2img.jpg"} width={200} height={200} alt="cindy-parker-walter-tsou-epa-hearing" />
        </div >
    )
}
