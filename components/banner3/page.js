        ...
        <div className="mb-8 flex px-8">
            ...
            <div className="w-3/4 p-6">
                ...
                <div className="border-[#5BA1B2] border-l-2 border-t-4 p-4">
                    ...
                    <p className="font-semibold">This new report from PSRN details the risks from injecting PFAS into Pennsylvania’s oil and gas wells, as well as risks from the disposal of millions of tons of liquid and solid waste associated with the wells.</p>
