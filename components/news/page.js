...
const RecentNews = () => {
    return (
        <div className="flex justify-center items-center my-8 py-4 px-6 md:px-16">
            <div>
                ...
                <div className="flex flex-col lg:flex lg:flex-row gap-4 md:flex md:flex-row">
                    <div className="border-l-2 border-t-4 border-cyan-800 p-4 w-full md:w-1/4">
                        {/* Title */}
