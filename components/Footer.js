...
const Footer = () => {
    return (
        <footer className='h-[200px] bg-black text-white flex justify-between items-center px-4 md:px-16'>
            <div className="left">
            ...
            <div className="bg-gray-400 h-[100px] w-0.5 hidden md:inline"></div>
            <div className="right justify-between items-center w-[60%] hidden md:flex">
            ...
            <div className="h-full w-10 flex-col justify-end items-end pt-10 hidden md:inline">
                <a href="#headerdiv">
